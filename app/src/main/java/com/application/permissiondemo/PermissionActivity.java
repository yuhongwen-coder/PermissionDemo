...
import com.application.permission_lib.PermissionLibActivity;
...
public class PermissionActivity extends AppCompatActivity implements View.OnClickListener, PermissionInterface {
    ...
    private TextView permissionLib;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        permissionLib = findViewById(R.id.permission);
        callPhone.setOnClickListener(this);
        openCarmera.setOnClickListener(this);
        permissionLib.setOnClickListener(this);
        //初始化
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.permission:
                ...
                intent.setClass(this, PermissionLibActivity.class);
